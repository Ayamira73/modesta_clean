        ...
        child: Column(
          children: [
            ...
            DropdownButton<String>(
              ...
              value: _shape,
              items: ['Hourglass', 'Pear', 'Apple', 'Rectangle', 'I am not sure'].map((s) => DropdownMenuItem(value: s, child: Text(s))).toList(),
            ...
            DropdownButton<String>(
              ...
              value: _skin,
              items: ['Fair', 'Light', 'Medium', 'Olive', 'Brown' 'Dark'].map((s) => DropdownMenuItem(value: s, child: Text(s))).toList(),
            ...
            DropdownButton<String>(
              ...
              value: _style,
              items: ['Casual', 'Street', 'Elegant', 'Minimal', 'Old money'].map((s) => DropdownMenuItem(value: s, child: Text(s))).toList(),
